...
public interface IToolItem {
     ...
     */
    default boolean damageItem(ItemStack stack, LivingEntity entity, int damage, boolean simulate) {
     ...
     */
    int damageItem(ItemStack stack, LivingEntity entity, int damage, boolean allowPartial, boolean simulate);
